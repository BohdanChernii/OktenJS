...
// 2176491947586100 -> 3
//
let numberList = 2176491947586100
const findAllOnes = (num) => {
  let res = (num + '').split('00')[0].split('')
  return res.reduce((acc, val) => val === '1' ? acc += 1 : acc, 0)
}
console.log(findAllOnes(numberList));
//
